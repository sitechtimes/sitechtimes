  ...
  <div class="footer-social-media-box">
    ...
    <div class="footer-social-media">
      ...
      <svg
        ...
        viewBox="0 0 448 512"
        class="footer-sm-icon instagram-icon svg-inline--fa fa-instagram-square fa-w-14"
      >
        <path
          fill="currentColor"
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        class="footer-sm-icon svg-inline--fa fa-twitter fa-w-16"
      >
        <path
          fill="currentColor"
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        class="footer-sm-icon facebook-icon svg-inline--fa fa-facebook fa-w-16"
      >
        <path
          fill="currentColor"
