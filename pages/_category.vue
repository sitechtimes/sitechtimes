...
export default {
  ...
  head: function() {
    return {
      meta: [
      { name: 'title', content: this.category },
      { name: 'description', content: "Click to read all articles about" + this.category + "writen by the SITECH Times team!"},
      { name: 'og:url', content: `https://dev.sitechtimes.com/${this.category}`},
      { name: 'og:site_name', content: 'SITECHTIMES'},
      { name: 'og:title', content: this.category },
      { name: 'og:section', content: this.category },
      { name: 'og:description', content: "Click to read all articles about" + this.category + "writen by the SITECH Times team!"},
      { name: 'og:image', content: this.articles[0].imageUrl },
      { name: 'og:image:alt', content: this.articles[0].imageAlt },
      { name: 'twitter:card', content: 'summary'},
      { name: 'twitter:url', content: `https://dev.sitechtimes.com/${this.category}`},
      { name: 'twitter:title', content: this.category },
      { name: 'twitter:description', content: "Click to read all articles about" + this.category + "writen by the SITECH Times team!"},,
