...
<div class="cat-main">
    <CardComponent v-if="articles[0]" :title="articles[0].title" :author="articles[0].user.name" :published="articles[0].createdAt" :imageUrl="articles[0].imageUrl" :category="category"/>
    </div>
...
.border-right{
  ...
  border-right: solid var(--primary-color) 0.5rem;
}
.cat-title{
  font-size: var(--h3);
}
